...
public class MainActivity extends AppCompatActivity {
    ...
    private void getData(){
        ...
        if(cursor.moveToFirst()){
            String nikdb = cursor.getString(cursor.getColumnIndex(DBmain.row_nik));
            String namadb = cursor.getString(cursor.getColumnIndex(DBmain.row_nama));
            String jkdb = cursor.getString(cursor.getColumnIndex(DBmain.row_jk));
            String keluhandb = cursor.getString(cursor.getColumnIndex(DBmain.row_keluhan));
            int persendb = cursor.getInt(cursor.getColumnIndex(DBmain.row_persentase));
            ...
            seekBarCemas.setProgress(persendb);
            seekBarCemas.setMax(100);
            cemas.setText(persendb + "/" + seekBarCemas.getMax());
            persentase = persendb;
